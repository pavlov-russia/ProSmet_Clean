---
role_id: SolutionArchitect
team_source: Team.yml
role_card: harness/build-team.md#solutionarchitect
claude_profile: .claude/agents/solution-architect.md
helper: harness/scripts/agents/solution_architect.py
task_selector:
...
# Solution Architect · Codex Profile
...
5. Запусти helper: `python3 harness/scripts/agents/solution_architect.py` для role summary или `--json` для machine-readable context.
