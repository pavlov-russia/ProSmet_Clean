...
role_card: harness/build-team.md#architect
claude_profile: .claude/agents/architect.md
helper: harness/scripts/agents/architect.py
task_selector:
  role: Architect
...
5. Запусти helper: `python3 harness/scripts/agents/architect.py` для role summary или `--json` для machine-readable context.
