...
Связано: `Vision.md`, `Scope.md`, `docs/ConceptualDesign.md`, `docs/Architecture.md`, `docs/Domain/DeterministicEstimation.md`, `docs/Evals/QualityGates.md`
...
sequenceDiagram
  ...
  Client->>Widget: Enters phone and params
  Widget->>API: POST /api/leads and /contact
  ...
  Calc-->>Review: calculation snapshot ready
